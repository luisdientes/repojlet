			 	...
			 	<% if ((gridLine != null) && (gridLine.rowCount() > 0)) { %> 
			 		<table width="100%" border="0" class="TablaGrande">
							...
							<% if (!idemisor.equals("1") && !idemisor.equals("5")){ %>
								<td align="center" id="pricechf">Price CHF</td>
								<td align="center" id="benefici">% Benef</td>
								<td align="center" id="impbenef">Imp. Benef</td>
								<td align="center" id="txprovid">Provider</td>
								<td align="center" id="txbuyerx">Buyer</td>
								<td align="center" id="txfundin">Funding</td>
							<% } %>
