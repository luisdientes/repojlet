			...
			<form name="simulado" action="/JLet/App" method="POST">
				...
				<table width="50%" align="center" border="0" class="fonts">
					<tr>
						...
						<td width="40%"><input type="text" name="imptotal" placeholder="$" onkeyup="format(this)" onchange="format(this)"/></td>
					</tr>
					<tr>
						<td>Gravamen Adu.</td>
					...
					<tr>
						...
						<td>&nbsp;</td>
						<td id="tdprmargorig"><input type="text" name="prmargorig" placeholder="%"/></td>
					</tr>
					<tr>
