...
<table >	
			...
			<div class="table-responsive">
				<table border="0" align="center" border="1">
					<tr class="fonts">
						<td align="center" class="cabecera input-b1" style=" ">Nombre:</td>
						<td><input style=";" type="text" name="txnombre"  size="44" class="input-m"/></td>
						
					</tr>
					<tr>	
						<td align="center" class="cabecera input-b1" style=" ">Marca</td>
						<td><input style=" " type="text" name="txmarcax"  size="44" class="input-m"/></td>
						<td align="center" class="cabecera input-b1" style=" ">Modelo</td>
						<td><input style=" " type="text" name="txmodelo"  size="44" class="input-m"/></td>	
						
					</tr>
					<tr>	
						<td align="center" class="cabecera input-b1" style=" ">Color</td>
						<td colspan="3"><input style=" " type="text" name="txcolorx"  size="44" class="input-m"/></td>							
						
					</tr>
					<tr class="fonts">
						<td align="center" class="cabecera input-b1" style=" " valign="center">Descripción:</td>
						<td><textarea name="txdescri" class="input-m" style="text-align:justify !important"/></textarea></td>
					</tr>
					
					<tr class="fonts">
						<td align="center" class="cabecera input-b1" style="  ">IMEI / Serie</td>
						<td><input  type="text" name="tximeixx"size="44" class="input-m"/></td>
					</tr>
					
					<tr class="fonts">
						<td align="center" class="cabecera input-b1" style="  ">Fecha entrada: </td>
