...
<body>
    ...
    <table align="center">
		<tr>
    	 ...
    	 <div class="nompanta" style="margin-left:5%" >Alta Reparación</div>
...
<table >	
			...
			<div class="table-responsive">
				<table border="0" align="center" border="1">
					...
					<tr class="fonts">
						<td align="center" class=" cabecera300 input-b350" style=" " valign="center">Descripción:</td>
					...
					<tr class="fonts">
						...
						<td align="center" class=" cabecera300 input-b350" style="  ">Coste Reparación</td>
					...
					<tr class="fonts">
						<td align="center" class=" cabecera300 input-b350" style="  ">Tiempo Garantía (días):</td>
