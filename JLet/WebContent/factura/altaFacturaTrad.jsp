...
<%
	...
	System.out.println("emisor-------->  "+ pre_idemisor);
...
function initRepara(){
	...
	try{
		...
		function calendarSetup(){
			...
			Calendar.setup({ 
				inputField : "fhenviox",    // id del campo de texto 
				ifFormat   : "%d/%m/%Y",    // formato de la fecha que se escriba en el campo de texto 
				button     : "lanzador"     // el id del botón que lanzará el calendario 
			});
		}
	...
	<table width="98%" align="center">
 	...
 	<div class="nompanta" >Alta Factura</div>	
		...
		<div class="centradoFac">
			...
			<table cellspacing="10" border="0" align="center" class="tablaGrande">
				...
				<tr>
					...
					<td  style="width:200px;"><input style="width:100%" type="text" id="idclibusq" name="idclibusq" value="" onChange="muestraCli(this.value);" class="input-m"></td>
					...
					<% 
					  ...
					  <% } else if (idemisor.equals("3")){ %>
					  	<td style="width:200px;">
				  	 	 ...
				  	 	 <td class="input-b1">Entregado por</td>
				  			<td   style="width:200px;"><input class="input-m" style="width:100%" type="text" name="portetot" id="portetot"/></td>
			 		
					  <% } else { %>
					  	<td class="input-b1" >Aplicar retención</td>
						<td><input type="checkbox" onclick="aplicaRetencion()" id="chkreten" />&nbsp;&nbsp;<span id="impreten" style="display:none"><input onchange="aplicaRetencion()" type="text" id="porcrete" name="impreten" size=3 style="width:30px"/>%</span></td>
					  <% } %>
				  	<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
				  	<td class="input-b1">Num. Seguimiento</td>
				  	<td   style="width:200px;"><input class="input-m" style="width:100%" type="text" name="numsegui" id="numsegui"/></td>
			
				 <td class="input-b1" style="width:35%">Fecha</td>
				  <td style="width:200px;">
				  		<input type="text" name="fhenviox" id="fhenviox" class="input-m" style="width:80%" onchange="comparaFechas(this.value);" > <img src="common/img/varios/fechas.png" style="cursor:pointer;position:relative;top:6px" width="24" height="24" border="0" title="Fecha Factura" id="lanzador">
				  </td>
				  
				  
				<td class="input-b1">Entregado por</td>
				  	<td   style="width:200px;"><input class="input-m" style="width:100%" type="text" name="entregpo" id="entregpo"/></td>
			 </tr>
			...
			<div id="lineastmp">
				...
				<table align="right" class="piefactu">
					<tr>
						...
						<td>
							<input type="text" name="baseimp" id="baseimp" disabled class="fonts6">
						</td>
					</tr>
					<tr>
						<td class="input-b1">Impuesto</td>
				  		<td>
				  			<input type="text" name="impuesto" id="impuesto" disabled class="fonts6">
				  		</td>
				  	</tr>
				  	...
				  	<tr style="display:none" id="muesrete">
						<td class="input-b1">Retención IRPF</td>
				  		<td>
				  			<input type="text" name="retencio" id="retencio" disabled class="fonts6">
				  		</td>
				  	</tr>
				  	...
				  	<tr>
				  		...
				  		<td>
				  			<input type="text" name="txtotal" ID="total" disabled class="fonts6">
				  		</td>
				  	</tr>		
				 </table>	
		...
		<form method="post" name="vistaPrevia" action="/JLet/App">
				...
				<input type="hidden" name="view" 		value="factura/vistaPreviaTrad.jsp"/>
				...
				<input type="hidden" name="numsegui" 	value="">
				<input type="hidden" name="entregpo" 	value="">
				<input type="hidden" name="fhenviox" 	value="">
				<input type="hidden" name="portetot" 	value="">
				<input  type="hidden" name="numtrans" id="tmp_numtrans"/>
