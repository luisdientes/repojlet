...
function filtrafactura(){
	...
	document.formMenu.view.value = "factura/listadoFacturasItbisEmisor.jsp";	
			...
			<% 
			  ...
			  for (int i = 0; i < grfactur.rowCount(); i++){ 
				 ...
				 <%	
			  	...
			  	<% if(!mesfact.equals(mesanter)){%>
			  				<tr>
				  			<td>&nbsp;</td>
				  			<td>&nbsp;</td>
				  			<td colspan="7" align="center" ><div class="input-b1"><script>document.write(devuelveMes(<%=mesfact%>))</script> <%=aniofa%></div></td>
				  			<td>&nbsp;</td>
				  			<td>&nbsp;</td>
				  			</tr>
			  			<% }
			  			
			  			System.out.println("mesfact   "+mesfact +"  VS "+mesanter );
	  					mesanter = grfactur.getStringCell(i,"fhfactur");
	  					mesanter = mesanter.substring(3, 5);
			  			%>
