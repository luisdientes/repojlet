	...
	<div id="lineastmp">
		...
		%>  	
				  		<tr>
					  	    ...
					  	    <td width="8%" class="fonts6" style="text-align:right" nowrap onclick="MuestraBorraLinea('<%=formateador.format(precioun)%>')" style="text-align:right" nowrap><%=formateador.format(precioun)%> <%=cddivisa %></td>
					  	    <td width="10%" class="fonts6" style="text-align:right" nowrap style="text-align:right" nowrap><%=formateador.format(descuent)%></td>
					  	    <td width="20%" class="fonts6" style="text-align:right" nowrap style="text-align:right" nowrap><%=formateador.format(precioto)%> <%=cddivisa %></td>
							<td width="5%"><a class="boton" onclick="borraLinea(<%=idlineax%>,<%=idemisor%>)" style="font-size:9px;font-weight:900;font-family:Arial;min-width:20px;border-radius:100%;min-height:20px;background-color:#C13030 !important">X</a> </td>
						</tr>
				<%	} catch (Exception e) { 
						e.printStackTrace();
		...
		%>			
			<tr>
				<td onclick="listadoProd('<%=idemisor%>')"><a class="boton" style="font-size:9px;font-weight:900;font-family:Arial;min-width:25px;border-radius:100%;min-height:25px;">+</a></td>  	
		  	    ...
		  	    <td width="29%"><input class="input-m" type="text" style="width:100% ; height:auto;" name="concepto" id="concepto"  onkeyup="if (event.keyCode == 13) acceso(1)"></td>
		  	    ...
		  	    <td width="10%"><input class="input-m" type="text" style="width:100%" name="descuent" id="descuent" onblur="acceso(1)"  onkeyup="if (event.keyCode == 13) acceso(1)"></td>
