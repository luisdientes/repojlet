...
public class GeneraXlsEnvioSrv extends Service {
    ...
    public void process(ObjectIO input, ObjectIO output){
        ...
        try {
        	...
        	//Construyo el Nombre
        	filename = "EnvioTradens_"+ codeenvi +".xls";
    		...
    		crearEnvio(codeenvi, filename,idemisor);
    		...
    		//saco empresas de envio asociadas a ese idemisor
    ...
    public void formateoExcel(){
    	...
    	try {
			...
			creador.definirLongitudCelda(nColumn++,30);		/* IMEICODE */
			creador.definirLongitudCelda(nColumn++,16);		/* QUANTITY */
			creador.definirLongitudCelda(nColumn++,20);		/* PRICECHF */
			...
			creador.definirLongitudCelda(nColumn++,5);		/* WITHBOXX */
			creador.definirLongitudCelda(nColumn++,5);		/* WITHUSBX */
			...
			creador.rellenarCelda(lineaCab, nColumn++, "Imei", creador.getformatoCabecera());						/* IMEICODE */
			creador.rellenarCelda(lineaCab, nColumn++, "Quantity", creador.getformatoCabecera());					/* IMEICODE */
			creador.rellenarCelda(lineaCab, nColumn++, "P/Unit CHF", creador.getformatoCabecera());					/* PRICECHF */
			...
			creador.rellenarCelda(lineaCab, nColumn++, "Box", creador.getformatoCabecera());						/* WITHBOXX */
			creador.rellenarCelda(lineaCab, nColumn++, "USB", creador.getformatoCabecera());						/* WITHUSBX */
			creador.rellenarCelda(lineaCab, nColumn++, "Category", creador.getformatoCabecera());					/* CDCATEGO */
    ...
    public void pintoLineas(Grid dataPint){
    	...
    	for (int i = 0; i < dataPint.rowCount(); i++) {
    		...
    		try {
	    		...
	    		imeicode = dataPint.getStringCell(i,"imeicode");
	    		quantity = "1";
	    		pricechf = dataPint.getStringCell(i,"pricechf");
	    		...
	    		withboxx = dataPint.getStringCell(i,"withboxx");
	    		withusbx = dataPint.getStringCell(i,"withusbx");
	    		...
	    		creador.rellenarCelda(nLinea, nColumn++, imeicode, creador.getformatoIzquierda());
	    		creador.rellenarCelda(nLinea, nColumn++, new BigDecimal(quantity), creador.getformatoEntero());
	    		creador.rellenarCelda(nLinea, nColumn++, new BigDecimal(pricechf), creador.getformato2Decimal());
	    		...
	    		creador.rellenarCelda(nLinea, nColumn++, withboxx, creador.getformatoIzquierda());
	    		creador.rellenarCelda(nLinea, nColumn++, withusbx, creador.getformatoIzquierda());
    ...
    public int crearEnvio(String codeenvi, String filecrea,String idemisor){
    	...
    	try {
    		...
    		updLinBDIn.setValue("idemisor",idemisor);
