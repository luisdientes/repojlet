...
public class ListCotizadorSrv extends Service {
    ...
    public void formateoExcel(){
    	...
    	try {
			...
			creador.definirLongitudCelda(nColumn++,30);		/* CUSTOTAX */
			creador.definirLongitudCelda(nColumn++,20);		/* CONSUTAX */
			creador.definirLongitudCelda(nColumn++,20);		/* FLETECST */
			creador.definirLongitudCelda(nColumn++,20);		/* ITBISIMP */
			creador.definirLongitudCelda(nColumn++,20);		/* TRAMADUA */
			creador.definirLongitudCelda(nColumn++,20);		/* ALMACENA */
			creador.definirLongitudCelda(nColumn++,20);		/* CARGNAVI */
			creador.definirLongitudCelda(nColumn++,20);		/* MOVCONTE */
			creador.definirLongitudCelda(nColumn++,20);		/* COSTETOT */
			creador.definirLongitudCelda(nColumn++,20);		/* PRICMPSP */
			creador.definirLongitudCelda(nColumn++,20);		/* PRICIZUM */
			...
			creador.rellenarCelda(lineaCab, nColumn++, "Custom Tax", creador.getformatoCabecera());					/* CUSTOTAX */
			creador.rellenarCelda(lineaCab, nColumn++, "Consumo Tax", creador.getformatoCabecera());				/* CONSUTAX */
    	...
    	for (int i = 0; i < dataPint.rowCount(); i++) {
    		...
    		try {
	    		...
	    		try {
	    			...
	    			double dcustotax	= impcalcu * dprcustotax;
	    			double dconsutax	= impcalcu * dprconsutax;
	    			double dfletecst	= impcalcu * dprfletecst;
	    			double ditbisimp	= impcalcu * dpritbisimp;
	    			double dtramadua	= impcalcu * dprtramadua;
	    			double dalmacena	= impcalcu * dpralmacena;
	    			double dmovconte	= impcalcu * dprmovconte;
	    			double dcargnavi	= impcalcu * dprcargnavi;
