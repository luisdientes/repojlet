...
public class ListAlbaranesEmisorSrv extends Service {

    public ListAlbaranesEmisorSrv() {
      super();
    }
    ...
    public void process(ObjectIO input, ObjectIO output){
        ...
        try{        	
        	...
        	// listado albaranes 
        	ListAlbaranesBDIn ListAlbaBDIn  = new ListAlbaranesBDIn();  
        	ListAlbaBDIn.setValue("idemisor", idemisor);
        	//ListAlbaBDIn.setValue("aniofact", aniofact);
        	ListAlbaBDIn.setValue("isalbara", isalbara);
        	...
        	ListAlbaBDIn.setValue("isalbara", "S");
        	
        	ListAlbaranesBD ListTipoBD = new ListAlbaranesBD(ListAlbaBDIn);
        	...
        	ListCliFactBDIn.setValue("isalbara", "S");
