...
public class UpdTempFacturaSrv extends Service {
    ...
    public void process(ObjectIO input, ObjectIO output){
        ...
        try{        	
        	...
        	//DETALLE CLIENTE
			   ...
			   gridDtCl = DetCliBD.execSelect();
			   
			   txrazons = gridDtCl.getStringCell(0, "txrazons");
			   cdnifxxx = gridDtCl.getStringCell(0, "idfiscal");
			   cdintern = gridDtCl.getStringCell(0, "cdintern");
			   
			   
			   // LINEAS FACTURA
			   ListLineasBDIn listLineasBDIn = new ListLineasBDIn();
		    	listLineasBDIn.setValue("idemisor", idemisor);
		    	listLineasBDIn.setValue("idclient", idclient);
		    	listLineasBDIn.setValue("tpclient", tpclient);
		    	listLineasBDIn.setValue("idtmpfra", idtmpfra);
		    	
		    	ListLineasBD  listLineasBD = new ListLineasBD(listLineasBDIn);
		    	listLineasBD.setConnection(con);
		    	gridResu = listLineasBD.execSelect();
        	...
        	output.setValue("cdnifxxx", cdnifxxx);
        	output.setValue("fhfactur", fhfactur);
