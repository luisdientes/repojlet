...
public class ExcelConsultasSrv extends Service {
    ...
    public void process(ObjectIO input, ObjectIO output){
    	...
    	/*    String pathimgx = "E:/DATOS/tmp/pieces/";
    	    ...
    	    String pathimgx = PropiedadesJLet.getInstance().getProperty("path.gen.excelpi");
            String nameimgx = "1_T-PEN.jpg";  	
    		...
    		String miliseg = String.valueOf(System.currentTimeMillis());
    		...
    		creador.cerrarLibro(miliseg,idemisor);
    		
    		filecrea = miliseg+=".xlsx";
