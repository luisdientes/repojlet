...
public class FRAvetustaCSSrv extends Service {
	...
	String rmtomoxx = "22.991";
	String rmlibrox = "0";
	String rmfoliox = "80";
	String rmhojaxx = "M-411897";
    ...
    public void process(ObjectIO input, ObjectIO output){
    	...
    	try {
	       ...
	       /* if(mcpagado != null && mcpagado.equals("S")){
	        //	namefile ="VET2_"+aniofact +"_"+ cabecNFC +"_"+ numerNFC +".pdf";
		       destinox ="VET_"+aniofact +"_"+ cabecNFC +"_"+ numerNFC +".pdf";
        	}else{*/
        	//	destinox ="VET_"+aniofact +"_"+ cabecNFC +"_"+ numerNFC +".pdf";
        		//namefile = destinox;
        		namefile = "VET_"+aniofact +"_"+ cabecNFC +"_"+ numerNFC +".pdf";
        //	}
        ...
        /*	
        	if(mcpagado != null && mcpagado.equals("S")){
        		generaMarcaAgua(filecrea,destinox);
        	}*/
        }
    }
...
// ------------------------------------------ START PINTAR DATOS -----------------------------
    ...
    public void pintaFecha(){
    	...
    	try {
            ...
            chunkNom = new Chunk(numerNFC +"-"+aniofact, fontboldVCS);
            contcell = new Phrase(chunkNom);
	...
	if (tipofact == 1){
	    	...
	    	if (tipofact == 1){
		    	...
		    	FRAparen.absTextBoldColor(writer,datosBan,margeniz + 200,180,10,new BaseColor(13,71,117));
		    	datosBan = "IBAN ES44 0030 5237 7500 0040 0271";
    ...
    BaseColor bkcolor = new BaseColor(255, 255, 255);
		...
		cell = FRAparen.getCelda(informadi,fuente,bkcolor,"left");
        cell.setBackgroundColor(new BaseColor(221, 225, 234));
        cell.setBorder(1);
        cell.setBorderColor(new BaseColor(255,255,255));
        table.addCell(cell);
        ...
        PdfContentByte canvas = writer.getDirectContent();
        table.writeSelectedRows(0, -1, margeniz, 255, canvas);
    ...
    public void pintaPiePagina(){
    	...
    	try {
    		...
    		FRAparen.absTextColor(writer, "VETUSTA CORPORATE SERVICES S.L. - Inscrito en el registro mercantil de "+ registro +", libro "+ rmlibrox +", tomo "+ rmtomoxx +", folio "+ rmfoliox +", hoja "+ rmhojaxx,margeniz,altlinea + 20,7,new BaseColor(13,71,117));
...
public void actualizaEstadoAlba(String cdestado){
 ...
 public void generaMarcaAgua( String origen, String destino){
	 Document document = new Document();
     //Se crea un reader para el PDF
	
	
     String folderin = PropiedadesJLet.getInstance().getProperty("path.gen.invoice") + "emisor_"+ emisclie + "/"; 
     folderin = folderin + destino;	 
	 try{
		  PdfReader reader = new PdfReader(origen);
		  String imageUrl = PropiedadesJLet.getInstance().getProperty("path.img.logoinvoice") + "sello-pagado.png";
		  //obtenemos el número de páginas del archivo
		  int total = reader.getNumberOfPages();
		 
		  PdfWriter pdfwriter = PdfWriter.getInstance(document, new FileOutputStream(folderin));
		 ...
		 System.out.println("Error al crear marca de agua");
	 }
      document.close();
 }
