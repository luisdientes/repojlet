...
public class FRAcrinbuESSrv extends Service {
...
// ------------------------------------------ START PINTAR DATOS -----------------------------
    ...
    public void pintaPiePagina(){
    	...
    	try {
    		...
    		FRAparen.absTextColor(writer, "CRINBU SOLUTIONS SL. - Inscrito en el registro mercantil de "+ registro +", libro "+ rmlibrox +", tomo "+ rmtomoxx +", folio "+ rmfoliox +", hoja "+ rmhojaxx,margeniz,altlinea + 20,7,new BaseColor(60,60,59));
