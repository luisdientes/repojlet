...
public class TablaColumnas extends Service {
    ...
    public void process(ObjectIO input, ObjectIO output) throws Exception{
    	...
    	try {
    				textocol = input.getStringValue("textocol");
	 
		    	Rectangle pageSize = new Rectangle(PageSize.LETTER.rotate());
...
// ------------------------------------------ PINTAR DATOS -----------------------------
    ...
    public void pintaTabla(){
    	 try {
				...
				Paragraph frase = new Paragraph("oleeeeee");
				//frase.add((Element) styles);
			
				
				 documento.add(new Paragraph("entraaaaaaaaaaaa"));
 ...
 public void pintaCuerpoTabla(PdfPTable tabla) throws DocumentException{
	 PdfContentByte canvas = writer.getDirectContent();
	 PdfTemplate textTemplate = canvas.createTemplate(600, 600); //The width and height of the text to be inserted

	 ColumnText columnText = new ColumnText(textTemplate);

	 columnText.setSimpleColumn(0, 0, 600, 600);
	 columnText.addElement(new Paragraph(textocol));
	 ...
	 textImg.scaleAbsolute(600, 600);
	 textImg.setRotationDegrees((float) - 1); //Arbitrary number of degress
	 textImg.setAbsolutePosition(10, 10);

	 //Add the text to the pdf
	 documento.add(textImg);
